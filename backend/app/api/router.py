...
api_router.include_router(excel_router, dependencies=user_dependencies)
api_router.include_router(report_router, dependencies=user_dependencies)
api_router.include_router(batch_router, dependencies=user_dependencies)
api_router.include_router(clinical_info_router, dependencies=user_dependencies)
api_router.include_router(task_router, dependencies=user_dependencies)
api_router.include_router(knowledge_router, dependencies=user_dependencies)
api_router.include_router(reference_router, dependencies=user_dependencies)
