...
# CRC301 remains outside this release until its case-level UAT is complete.
# The same scope is enforced in the Web API, reportgen core, and compiled UI.
export RG_WEB_DISABLED_PROJECT_TYPES="${RG_WEB_DISABLED_PROJECT_TYPES:-crc_301_msi}"
